...
<tr class="table-secondary">
      ...
      <td>
        <ul>  
          ...
          <li style="color:black"><strong>HW5 Assigned: 02/18/2026; HW5 In-class demos Due: 02/25/2026</strong></li> 
...
<tr class="table-secondary">
      ...
      <td>
        <ul>
          <li><strong><a href="Downloads/LastName_ExecutiveSummary.docx" style="color:red;" target="_blank">HW5: Guest Lecture Summary [Download Template]</a></strong></li> <strong style="color:black">HW5 Assigned: 02/25/2026; HW5 Due: 03/04/2026</strong></li>
          <li>Proxmity sensing using Thonny IDE</li>
          <li>Proxmity sensing using bash script</li>    
          <li style="color:black"><strong>Graded student demos: Proxmity sensing on boot [Graded Lab Activity]</strong></li>   
          <li style="color:black"><strong>Raspberry Pi messaging with Python scripts [Graded Lab Activity]</strong></li> 
          <li style="color:black"><strong>In-class Flask API development [Graded Lab Activity]</strong></li>       
        </ul>
      </td>
