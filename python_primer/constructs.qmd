...
<table class="table table-hover w-auto">
  ...
  <tr class="table-secondary">
      <th scope="row">Functions: A first look</th>
        ...
        <td>
            <a href="./unit0/modules/module2.qmd">Module 0 </a>
        </td>
    </tr>
  <tr class="table-secondary">
      <th scope="row">Loops: the `for`-loop</th>
        <td>
            desc here
        </td>
        <td>
            <a href="./unit0/modules/module3.qmd">Module 1 </a>
        </td>
    </tr>
    <tr class="table-secondary">
      <th scope="row">Conditionals</th>
        ...
        <td>
            <a href="./unit1/modules/module1.qmd">Module 2 </a>
        </td>
    </tr>
    <tr class="table-secondary">
      <th scope="row">Functions</th>
        ...
        <td>
            <a href="./unit1/modules/module2.qmd">Module 3 </a>
        </td>
    </tr>
    <tr class="table-secondary">
      <th scope="row">`while` loops, I/O</th>
        <td>
            desc here
        </td>
        <td>
            <a href="./unit1/modules/module4.qmd">Module 4 </a>
        </td>
    </tr>
  </tbody>
</table>
